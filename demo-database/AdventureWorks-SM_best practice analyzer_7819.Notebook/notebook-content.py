...
dataset = "AdventureWorks-SM" # Enter the name or ID of the semantic model
workspace = "demo-database" # Enter the workspace name or ID in which the semantic model exists
